...
public class InventoryScreen {
	...
	private void init() throws SlickException {
		...
		slots_top = new Point[] { new Point(1, 345), new Point(35, 345),
				new Point(69, 345), new Point(103, 345), new Point(137, 345),
				new Point(171, 345), new Point(205, 345), new Point(239, 345),
				new Point(273, 345) };
		slots_mid_1 = new Point[] { new Point(1, 379), new Point(35, 379),
				new Point(69, 379), new Point(103, 379), new Point(137, 379),
				new Point(171, 379), new Point(205, 379), new Point(239, 379),
				new Point(273, 379) };
		slots_mid_2 = new Point[] { new Point(1, 413), new Point(35, 413),
				new Point(69, 413), new Point(103, 413), new Point(137, 413),
				new Point(171, 413), new Point(205, 413), new Point(239, 413),
				new Point(273, 413) };
		slots_bottom = new Point[] { new Point(1, 447), new Point(35, 447),
				new Point(69, 447), new Point(103, 447), new Point(137, 447),
				new Point(171, 447), new Point(205, 447), new Point(239, 447),
				new Point(273, 447) };

		slots_top_boxes = new Rectangle[] {
				new Rectangle(slots_top[0].x, slots_top[0].y, 32, 32),
		...
		slots_mid_1_boxes = new Rectangle[] {
				new Rectangle(slots_mid_1[0].x, slots_mid_1[0].y, 32, 32),
		...
		slots_mid_2_boxes = new Rectangle[] {
				new Rectangle(slots_mid_2[0].x, slots_mid_2[0].y, 32, 32),
		...
		slots_bottom_boxes = new Rectangle[] {
				new Rectangle(slots_bottom[0].x, slots_bottom[0].y, 32, 32),
	...
	public void renderInventoryScreen(Graphics g) {
		...
		if (invPlayer.getAvailableIndex() < 9
				&& invPlayer.getAvailableIndex() >= 0) {
			for (Item i : Player.inventory.getItems()) {
				if (i != null) {
					i.icon.draw(slots_top[invPlayer.getAvailableIndex() - 1].x,
							slots_top[invPlayer.getAvailableIndex()].y);
				}
			}
		} else if (invPlayer.getAvailableIndex() < 18
				&& invPlayer.getAvailableIndex() >= 9) {
			for (Item i : Player.inventory.getItems()) {
				if (i != null) {
					i.icon.draw(
							slots_mid_1[invPlayer.getAvailableIndex() - 1].x,
							slots_mid_1[invPlayer.getAvailableIndex()].y);
				}
			}
		} else if (invPlayer.getAvailableIndex() < 27
				&& invPlayer.getAvailableIndex() >= 18) {
			for (Item i : Player.inventory.getItems()) {
				if (i != null) {
					i.icon.draw(
							slots_mid_2[invPlayer.getAvailableIndex() - 1].x,
							slots_mid_2[invPlayer.getAvailableIndex()].y);
				}
			}
		} else if (invPlayer.getAvailableIndex() < 36
				&& invPlayer.getAvailableIndex() >= 27) {
			for (Item i : Player.inventory.getItems()) {
				if (i != null) {
					i.icon.draw(
							slots_bottom[invPlayer.getAvailableIndex() - 1].x,
							slots_bottom[invPlayer.getAvailableIndex()].y);
				}
			}
		}
	}
